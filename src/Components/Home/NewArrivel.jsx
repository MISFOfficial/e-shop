    ...
    <section className="py-16">
      <div className="md:flex md:items-center justify-between md:gap-12">
        ...
        <div className="relative ">
          ...
          />
          {/* Offer Tag */}
          <div className="absolute bottom-5 right-4 bg-yellow-400 text-dark2 font-bold px-4 py-2 rounded-full shadow-lg text-sm md:text-base">
            30% OFF
          </div>
        </div>
        ...
        <div className="mt-10 md:mt-0 md:w-1/2 text-center md:text-left">
          <h2 className="text-4xl md:text-5xl font-extrabold text-dark2 mb-4">
